...
class Regretter:
	...
	def __init__(self, input_dim, hidden1_dim, hidden2_dim, output_dim):
		self.weights_0 = np.random.randn(input_dim, hidden1_dim) * np.sqrt(2. / input_dim)
		self.weights_1 = np.random.randn(hidden1_dim, hidden2_dim) * np.sqrt(2. / hidden1_dim)
		self.weights_2 = np.random.randn(hidden2_dim, output_dim) * np.sqrt(2. / hidden2_dim)
